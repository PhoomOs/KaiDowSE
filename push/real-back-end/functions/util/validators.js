...
const isEmpty = (string) => {
  //   console.log("use isempty for : ", string);
...
// exports.testValidate = (data) => {
//   let errors = {};
//   if (isConsistOfSpecial(data)) {
//     errors.typeName = 'Cannot use Special Characters.';
//   }
//   return {
//     errors,
...
exports.validatePaymentAccount = (data) => {
  let errors = {};
  if (isEmpty(data.name)) {
    // console.log("chcek name");
...
exports.validateAddEmployee = (data) => {
  let errors = {};
