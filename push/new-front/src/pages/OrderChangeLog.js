...
function OrderChangeLog(props) {
  ...
  return (
    <div>
            ...
            <Card style={{ marginTop: '40px' }}>
              ...
              <MaterialTable
                ...
                onRowClick={(evt, selectedRow) => {
                  ...
                  setSelectedDetail(selectedRow.tableData.orderId);
                  setOpen(true);
                }}
                options={{
                  search: true,
      ...
      <DialogChangeLog open={open} handleClose={handleClose} />
    </div>
  );
}
...
const mapActionsToProps = { logChange, refundLog };

export default connect(mapStateToProps, mapActionsToProps)(OrderChangeLog);
